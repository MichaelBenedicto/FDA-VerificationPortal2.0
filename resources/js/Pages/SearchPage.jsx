...
export default function SearchPage() {
    ...
    const haccpColumns = ["ACCOUNTCODE", "ESTABLISHMENT_NAME", "PLANT_ADDRESS"];

    const haccpprodColumns = ["ACCOUNTCODE", "PRODUCT", "VALIDITY_DATE"];

    const fdawebsiteColumns = ["date_posted", "title", "category", "post_link"];
    ...
    const detailsFieldsMap = {
        ...
        xray: ["address", "issuance_date", "expiry_date"],
        ...
        cmdn: ["COMPANY_ADDRESS", "AUTHORIZATION_TYPE"],

        localcgmp: ["ADDRESS", "PRODUCTS"],
        ...
        PermitToRegister: ["PLANT_ADDRESS", "AUTHORIZED_PRODUCT_DOSAGE_FORM"],
    ...
    const columnsMap = {
        ...
        lto_hup: ["LTO_NUMBER", "ESTABLISHMENT_NAME", "ESTABLISHMENT_OWNER"],

        lto_tcca: ["LTO_NUMBER", "ESTABLISHMENT_NAME", "ESTABLISHMENT_OWNER"],

        otherEST: ["LTO_NUMBER", "ESTABLISHMENT_NAME", "ESTABLISHMENT_OWNER"],
    };
    ...
    const tabConfig = [
        ...
        {
            key: "lto_healthrelateddevice",
            label: "Health Related Device Industry",
            type: "expandable",
        },
        ...
        {
            key: "healthcare_waste",
            label: "Healthcate Waste",
            type: "expandable",
        },
        {
        ...
        {
            key: "csl_lot",
            label: "Lot Release Certificate",
            type: "expandable",
        },
        {
            key: "vat_exempt",
            label: "Vat-Exempt Health Products",
            type: "simple",
        },
        {
            key: "cosmetic_NN",
            label: "Cosmetic Product Notification",
            type: "expandable",
        },
        {
            key: "cmdn",
            label: "Medical Device Notification",
            type: "expandable",
        },
        { key: "localcgmp", label: "Local cGMP", type: "expandable" },
        {
            key: "desktopForeigncgmp",
            label: "Desktop Foreign cGMP",
            type: "expandable",
        },
        {
            key: "inspectedForeign",
            label: "Inspected Foreign cGMP",
            type: "expandable",
        },
        {
            key: "PermitToRegister",
            label: "Permit to Register",
            type: "expandable",
        },
    ...
    const handleSearch = async (searchQuery) => {
        ...
        try {
            ...
            const firstTabWithResults =
                tabConfig.find((tab) => normalizedResults[tab.key]?.length > 0)
                    ?.key || "lto_food";
            ...
            setPagination(
                Object.fromEntries(Object.keys(results).map((k) => [k, 1])),
            );
        ...
        <div className="w-screen h-screen flex flex-col items-center bg-gray-50 p-4 transition-all duration-700">
          ...
          ${isCentered ? "justify-center h-screen mt-0" : "mt-6"}`}
            >
                ...
                {loading && (
                    <p className="mt-4 text-gray-600 italic animate-pulse">
                        Searching...
                    </p>
                )}
            </div>
                ...
                <div className="flex items-center justify-between px-4">
                    ...
                    <div className="text-center flex-1">
                        <p className="text-gray-400 text-sm italic">
                            NOTE: The Information provided herein shall only be
                            used for purposes of verification and shall in no
                ...
                <table className="w-full border-collapse border border-gray-200 text-sm">
                    ...
                    <tbody>
                        {currentData.map((row, i) => {
                            ...
                            const isExpanded =
                                expandedRows.includes(globalIndex);
                            return (
            ...
            {totalPages > 1 && (
                <div className="flex justify-between items-center mt-4">
                    <button
                        ...
                        disabled={page === 1}
                        className={`px-3 py-1 rounded ${page === 1 ? "bg-gray-300 cursor-not-allowed" : "bg-green-700 text-white hover:bg-green-800"}`}
                    >
                        Previous
                    </button>
                    ...
                    <button
                        ...
                        className={`px-3 py-1 rounded ${page === totalPages ? "bg-gray-300 cursor-not-allowed" : "bg-green-700 text-white hover:bg-green-800"}`}
                    >
                        Next
                    </button>
                </div>
